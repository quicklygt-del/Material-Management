...
export default function HomePage() {
  ...
  /** 門戶租戶：URL ?tenant=WMS／CARB …，未設則用環境預設前綴 */
      ...
      <div className="flex flex-1 flex-col items-center justify-start px-4 pb-10 pt-8 sm:pt-12">
        <div className="w-full max-w-md space-y-3">
          ...
          <p className="text-center text-[10px] font-bold text-slate-500">
            租戶環境：<span className="font-black text-slate-700">{portalTenant}</span>
            （可於網址加上 <code className="rounded bg-slate-200 px-1">?tenant=</code>{" "}
            切換）
          </p>
          ...
          <p className="pt-2 text-center text-[10px] font-bold text-slate-400">
